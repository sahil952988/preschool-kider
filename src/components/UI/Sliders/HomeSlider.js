...
const HomeSlider = () => {
  ...
  return (
    <>
      <div className="header_top absolute h-[10px] 2xl:w-[1300px] xl:w-[1280px] lg:w-[1000px] md:w-[768px] sm:w-[640px] w-[375px] 2xl:ml-[105px] z-10 ">
      </div>
      ...
      <div className="header_bottom absolute h-[19px] 2xl:w-[1300px] xl:w-[1280px] lg:w-[1000px] md:w-[768px] sm:w-[640px] w-[375px] 2xl:ml-[105px] z-10 mt-[-18px] ">
      </div>
    </>
  )
}
