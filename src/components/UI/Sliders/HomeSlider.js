...
const HomeSlider = () => {
  ...
  return (
    <>
      <div className="header_top absolute h-[10px] 2xl:w-[1326px] xl:w-[1280px] w-full 2xl:ml-[105px] z-10 ">
      </div>
      ...
      <div className="header_bottom absolute h-[19px] 2xl:w-[1326px]  xl-[1280px] w-full 2xl:ml-[105px] z-10 mt-[-18px] ">
      </div>
    </>
  )
}
